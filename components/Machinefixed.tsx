...
const Machinefixed: React.FC = () => {
  ...
  return (
    <View className="flex-1 p-4 bg-white">
      ...
      <View className="items-center flex-2 mt-2 mb-8 py-2 rounded-2xl bg-green-100">
        <Text className="text-lg font-semibold text-center text-black">Machine is Fixed</Text>
      </View>
