  ...
  const handleGoBack = () => {
    ...
    <View className='items-center flex-1 mt-10'>
      ...
      <Text className='mt-4 font-bold'>
        ...
        <Text>
        Provide details on what caused the breakdown, whether it was mechanical, 
        electrical, etc.
        </Text>
        
        <Text className='mt-4 font-bold'>Resolution Details</Text>
        <Text>Include what actions were taken to resolve the breakdown, such as repairs, parts replaced, or system reboots</Text>

        <Text className='mt-4 font-bold'>
        Technician Information
        </Text>
        <Text>Display who attended to the breakdown, 
          including their name and contact details</Text>
...
<TouchableOpacity className='px-16 py-3 bg-green-950 rounded-3xl'>
