...
const Breakdownfinish: React.FC = () => {
  ...
  return (
    <View className="flex-1 p-4 bg-white">
      ...
      <View className="items-center flex-2 mt-2 mb-2 py-2 rounded-2xl bg-green-100">
        <Text className="text-lg font-semibold text-center text-black"> History of Breakdown</Text>
      </View>
      ...
      <View className="items-center flex-1">
        ...
        <View className="flex-row justify-between mt-auto mb-8 ml-2">
          <TouchableOpacity className="px-20 py-3 bg-[#0d6000] rounded-3xl ml-2" onPress={handleDone}>
            <Text
