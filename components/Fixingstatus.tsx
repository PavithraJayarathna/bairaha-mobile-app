  ...
  return (
    <View className="flex-1 p-4 bg-white">
      ...
      <View className="flex-row items-center justify-between mb-4 bg-gray-100 rounded-full">
        ...
        <Text className="text-xl font-bold">{breakdownDetails?.machinename.toUpperCase()}</Text>
      ...
      <View className="items-center flex-2 mt-2 mb-8 py-2 rounded-2xl bg-yellow-100">
          <Text className="text-lg font-semibold text-center text-black">Machine is being Fixed</Text>
      </View>
